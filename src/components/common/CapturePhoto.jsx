  ...
  return (
    <>
      <div className="absolute h-4/6 w-2/6 top-1/4 left-1/3 bg-gray-900 gap-3 rounded-lg pt-2 flex items-center justify-center">
        <div className="flex flex-col gap-4 w-full item-center justify-center">
          <div
          ...
          <button
            className="flex items-center justify-center ml-52  h-16 w-16 bg-white rounded-full cursor-pointer border-8 border-teal-light p-2 mb-10"
